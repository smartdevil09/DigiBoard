...
//specify where to find the  COURSE schema
const course = require('./models/courses');
const courses = require('./models/courses');

//specify where to find the  STUDENT schema
...
//in the app.get() method below we add a path for the profiles API 
//by adding /profiles, we tell the server that this method will be called every time http://localhost:8000/profiles is requested. 
